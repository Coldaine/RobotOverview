...
import { MODULE_NETS } from './wiring';
...
export const hangarData: HangarData = {
  ...
  units: [
    // ── ROBOTICS ──────────────────────────────────────────────────────────────
    {
      ...
      provenance: 'owner',
      summary:
        'Waveshare UGV Beast PT PI5 ROS2 Kit Acce (owner-confirmed 2026-07-27) with the stock pan-tilt 5MP camera, OAK-D Lite depth camera, and D500 LiDAR — all three ship with the ROS2 Kit; "Acce" means the host board was supplied separately. First unit of the fleet. Orin cutover: Jetson Orin Nano Super fitted and pack-powered via the UPS barrel pigtail (not driver-board USB-C). Live-verified 2026-07-30: ROS 2 Humble + ugv_ws at boot (`beast-ros-base.service`, lidar/odom/EKF up, allow_motion:=false); ESP32 + LiDAR talk over USB serial (/dev/ttyACM*), not GPIO UART jumpers. Heartbeat-stop test FAILED 2026-07-31 — do not enable motion without an operator stop path. Robot VLAN 192.168.20.x rejected — LAN 192.168.0.x + Tailscale. One host mounting strut still missing.',
      specs: [
        { label: 'Chassis', value: 'Tracked, all-terrain · slow, hard-stopping' },
        { label: 'Onboard host', value: 'Jetson Orin Nano Super — fitted · ROS base at boot (2026-07-30)' },
        { label: 'Motor control', value: 'ESP32 (PID) over USB serial · motion software-locked' },
        { label: 'Pan-tilt camera', value: '5MP · 160° · USB' },
        { label: 'Depth camera', value: 'OAK-D Lite · USB' },
        { label: 'LiDAR', value: 'D500 / STL-19P · 360° · USB serial bridge' },
        { label: 'Pack', value: '3S Li-ion (~11.1V)' },
        { label: 'Control', value: 'ROS 2 teleop over SSH · no web dashboard · watchdog gap' },
      ],
      ...
      shortcuts: [
        {
          ...
          note: 'LAN preferred (beast-01.local). Off-LAN: ssh beast-01-ts (100.107.16.72). Not the Pi-era robot VLAN.',
        },
      ],
      links: [
    ...
    },
    {
      ...
      provenance: 'owner',
      summary:
        'Owned NVIDIA Jetson Orin Nano 8GB developer kit — JetPack 6.2.2 / R36.5 on NVMe, ROS 2 Humble and ugv_ws built. Physically fitted into BEAST-01; live 2026-07-30: beast-ros-base.service at boot, ESP32+LiDAR over USB serial, motion locked (allow_motion:=false). Powered from the pack via the UPS board barrel-jack lead, not the driver board back-feed path. Heartbeat-stop gap (2026-07-31) and missing mount strut remain before unsupervised drive.',
      specs: [
        ...
        { label: 'Cutover', value: 'Fitted · ROS base live · motion locked · HB gap' },
      ],
  ...
  missions: [
    {
      ...
      objectives: [
        ...
        { text: 'Add cmd_vel timeout / firmware heartbeat — stale-command stop FAILED 2026-07-31', done: false },
        { text: 'Dry-run teleop path around pillars + ductwork (allow_motion only with live stop path)', done: false },
      ...
      afterAction: [
        ...
        '2026-07-28 OP-ORIN-POWER: Jetson Orin Nano Super fitted and network-verified by live SSH (hostname beast-01, LAN/Wi-Fi/Tailscale all up), powered via the UPS board\'s factory barrel-jack pigtail rather than the driver board\'s back-feeding USB-C.',
        '2026-07-30 OP-BEAST-NET: Robot VLAN 192.168.20.x rejected for Orin — stay on general LAN 192.168.0.x + Tailscale. Pi Control UI URLs retired from Hangar shortcuts. Live ROS base confirmed (USB serial ESP32+LiDAR; GPIO UART jumper plan superseded).',
        '2026-07-31 OP-BEAST-HB: Heartbeat-stop test FAILED — ESP32 latched last /cmd_vel for minutes after publisher death. Motion re-locked (allow_motion:=false). Do not unlock without a cmd_vel-timeout watchdog.',
      ],
      insights: [
        'dust-backscatter',
        'power-rail',
  ...
  insights: [
    ...
    {
      id: 'orin-host-gap',
      title: 'Pi-out gap (superseded) — Orin now fitted',
      body: 'Historical 2026-07-22: Raspberry Pi 5 removed; host mount empty while Orin was being fitted. SUPERSEDED 2026-07-28 by orin-barrel-jack-power — Orin Nano Super is physically fitted, pack-powered via the UPS barrel pigtail, and SSH-verified on LAN 192.168.0.x + Tailscale. Remaining blocker is ESP32 UART jumpers (pins 8/10 + GND) and mounting strut, not “no upper computer.” Robot VLAN 192.168.20.x is rejected — stay on general LAN + Tailscale.',
      tags: ['beast', 'orin', 'cutover', 'operations', 'historical'],
      bay: 'robotics',
      units: ['orin-nano', 'pi5'],
      missions: [],
      confidence: 'high',
      source: 'Superseded by live SSH 2026-07-28; operator network decision 2026-07-30',
      capturedAt: '2026-07-22',
    },
    {
  ...
  activity: [
    ...
    },
    {
      ...
      kind: 'mission',
      text: 'OP-ORIN-GAP (historical): Pi removed mid-cutover — superseded 2026-07-28 when Orin fitted + SSH-verified.',
    },
    {
      id: 'a-beast-slow',
