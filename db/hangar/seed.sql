...
INSERT INTO tags(namespace,name,label) VALUES ('class','Edge AI ΓÇö Industrial Tier','Edge AI ΓÇö Industrial Tier') ON CONFLICT (namespace,name) DO NOTHING;
...
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('rover-slot-2','module','Open Rover Slot',NULL,NULL,NULL,'wishlist','wishlist','inferred',false,'Reserved bay for the next ground unit or aerial drone as the fleet grows.',NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,'[{"label":"Status","value":"Empty ΓÇö future acquisition"}]'::jsonb,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('workstation','module','Threadripper / RTX 5090',NULL,NULL,'CORE-PRIME','operational','deployed','owner',true,'Blackwell-class desktop. The off-board "cloud brain" for the fleet: trains policies, runs VLM/LLM reasoning, heavy perception ΓÇö streamed to units over WiFi 6. Compute is never the bottleneck; the network tail is.',NULL,NULL,NULL,'owned',NULL,1,600,NULL,'mains',NULL,NULL,NULL,'[{"label":"GPU","value":"RTX 5090 ┬╖ 32GB GDDR7"},{"label":"Arch","value":"Blackwell"},{"label":"CPU","value":"Threadripper"},{"label":"Role","value":"Train + offboard inference"},{"label":"Link","value":"WiFi 6 LAN to fleet"}]'::jsonb,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('pi5','module','Raspberry Pi 5',NULL,NULL,'EDGE-PI','operational','assembled','owner',false,'Onboard host on the Beast: teleop, streaming, I/O, and the stale-command watchdog. No CUDA GPU, so learned-policy inference lives offboard on the 5090. Constrained 5V/5A rail is a real design limit.',NULL,NULL,NULL,'owned',NULL,1,25,5,'5V',NULL,NULL,NULL,'[{"label":"SoC","value":"BCM2712 ┬╖ quad A76"},{"label":"GPU","value":"VideoCore (no CUDA)"},{"label":"Rail","value":"5V / 5A ΓÇö protect it"},{"label":"Role","value":"Teleop ┬╖ stream ┬╖ watchdog"}]'::jsonb,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('orin-nano','module','Jetson Orin Nano Super',NULL,NULL,'ORIN-NX?','researching','wishlist','inferred',false,'Candidate onboard CUDA brain for dropout-proof, in-motion autonomy. Ampere-gen, the stable mainstream entry tier (lifecycle extended through 2032). Only needed once the WiFi-offload path is outgrown.',NULL,NULL,NULL,NULL,'buy when autonomy needed',1,25,NULL,'battery',NULL,249,NULL,'[{"label":"AI perf","value":"up to 67 TOPS (Super)"},{"label":"Arch","value":"Ampere"},{"label":"Power","value":"7ΓÇô25 W"},{"label":"Memory","value":"8 GB"},{"label":"Stack","value":"CUDA ┬╖ TensorRT ┬╖ Isaac ROS"},{"label":"Lifecycle","value":"through 2032"}]'::jsonb,'[{"label":"NVIDIA Jetson Orin","url":"https://www.nvidia.com/en-us/autonomous-machines/embedded-systems/jetson-orin/"}]'::jsonb,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('jetson-thor','module','Jetson Thor (T4000)',NULL,NULL,NULL,'researching','wishlist','inferred',false,'Blackwell in an embedded module ΓÇö but the wrong tier for a hobby rover. Built for humanoids and industrial AMRs. Logged for the research horizon, not the buy list.',NULL,NULL,NULL,NULL,'Q2 2026 ┬╖ wrong tier',1,75,NULL,'battery',NULL,1999,NULL,'[{"label":"AI perf","value":"1,200 FP4 TFLOPS"},{"label":"Arch","value":"Blackwell"},{"label":"Power","value":"40ΓÇô75 W"},{"label":"Memory","value":"64 GB"},{"label":"Price","value":"~$1,999 @ 1k vol"},{"label":"Avail","value":"~Q2 2026"}]'::jsonb,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('udm-pro-max','module','UniFi UDM Pro Max',NULL,NULL,'GATEWAY','operational','deployed','owner',false,'Core of Network Ops ΓÇö gateway, controller, and the spine the offload link rides on.',NULL,NULL,'Home Assistant','owned',NULL,1,33,NULL,'mains',NULL,NULL,NULL,'[{"label":"Role","value":"Gateway + UniFi controller"},{"label":"Uplink","value":"10G homelab switching"}]'::jsonb,NULL,NULL,NULL);
...
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('unifi-cams','module','UniFi G6 PTZ Cameras',NULL,NULL,NULL,'operational','deployed','owner',false,'PTZ camera coverage across the property ΓÇö eyes for the base, distinct from on-rover sensing.',NULL,NULL,'Home Assistant','owned',NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,'[{"label":"Type","value":"G6 PTZ"}]'::jsonb,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('home-assistant','module','Home Assistant Hub',NULL,NULL,'HA-CORE','operational','deployed','owner',false,'Whole-home automation brain with a Thread border router. Referenced by the Hangar, never controlled by it ΓÇö the Hangar catalogs, it does not operate.',NULL,NULL,NULL,'owned',NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,'[{"label":"Thread","value":"ZBT-2 border router"},{"label":"Climate","value":"Ecobee"},{"label":"Pool","value":"Pentair via Elfin EW11"},{"label":"Irrigation","value":"B-hyve"},{"label":"Energy","value":"Emporia Vue"},{"label":"Display","value":"LG C5 OLED"}]'::jsonb,NULL,NULL,NULL);
...
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('light-bar','module','RC Crawler Aluminum LED Light Bar',NULL,NULL,NULL,'buy-next','wishlist','inferred',false,'Wide flood, rugged, 2SΓÇô3S input ΓÇö runs off the battery rail, not the Pi. Mount forward + angled down ~15ΓÇô20┬░ to light the floor without blasting dust at lens level.',NULL,NULL,NULL,NULL,NULL,1,8,NULL,'battery',85,35,18,NULL,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('crawler-led-kit','module','INJORA / MEUS Crawler LED Kit',NULL,NULL,NULL,'watching','wishlist','inferred',false,'Cheapest path ΓÇö multiple small LEDs you can place and offset individually off the lens axis.',NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,18,10,NULL,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('depth-cam','module','Integrated Depth Camera (Orbbec-class)',NULL,NULL,NULL,'researching','wishlist','inferred',false,'Factory-calibrated RGB-D on one USB stream ΓÇö erases camera intrinsics, extrinsics, and time-sync work. Computes depth onboard, so the host streams it without a GPU. The "reach high but solve power" first step.',NULL,NULL,NULL,NULL,NULL,1,5,5,'5V',140,230,NULL,NULL,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('standalone-lidar','module','Standalone LiDAR (~$500 class)',NULL,NULL,NULL,'researching','wishlist','inferred',false,'Mind-blowing range/coverage but LiDAR-only. Adds extrinsic calibration + time-sync burden, and more total draw ΓÇö compounds the Pi power problem. Defer until the pipeline exists.',NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,500,420,NULL,NULL,NULL,NULL);
...
INSERT INTO asset_tags(asset_id,tag_id) SELECT 'jetson-thor',id FROM tags WHERE namespace='class' AND name='Edge AI ΓÇö Industrial Tier' ON CONFLICT DO NOTHING;
...
-- hotspots + sockets + loadout_assignments
...
INSERT INTO loadout_assignments(socket_id,asset_id) SELECT id,'pi5' FROM sockets WHERE host_asset_id='beast' AND name='Host Controller Mount' ON CONFLICT DO NOTHING;
...
INSERT INTO loadout_assignments(socket_id,asset_id) SELECT id,'stock-ups' FROM sockets WHERE host_asset_id='beast' AND name='Undercarriage Bay' ON CONFLICT DO NOTHING;
...
INSERT INTO loadout_assignments(socket_id,asset_id) SELECT id,'roarm-m2' FROM sockets WHERE host_asset_id='beast' AND name='Serial Bus Servo' ON CONFLICT DO NOTHING;
...
INSERT INTO missions(id,code,name,status,objective,environment) VALUES ('undercroft','MSN-01','Mission: Undercroft','planning','Haul Cat6 cable ends through the crawlspace by remote-piloting the Beast.','Large crawlspace ΓÇö walkable semi-crouched. Open but for support pillars, pipes, and ductwork (the Beast generally passes under). Low light. Dusty.');
...
INSERT INTO capabilities(id,name,description,unlocked) VALUES ('onboard-autonomy','Dropout-Proof Onboard Autonomy','In-motion autonomy that survives a WiFi dropout ΓÇö needs a CUDA brain on the rover (Orin).',false);
...
INSERT INTO capabilities(id,name,description,unlocked) VALUES ('long-range-mapping','Long-Range Mapping','Standalone LiDAR geometry at range ΓÇö gated behind calibration + time-sync work.',false);
...
-- wishlist_meta
INSERT INTO wishlist_meta(asset_id,rationale,unlocks_capability_id,risk_note,for_asset_id,for_mission_id) VALUES ('light-bar','Wide flood, rugged, 2SΓÇô3S input ΓÇö runs off the battery rail, not the Pi. Mount forward + angled down ~15ΓÇô20┬░ to light the floor without blasting dust at lens level.','night-ops','Import variants vary in driver quality; verify 3S rating.','beast','undercroft');
INSERT INTO wishlist_meta(asset_id,rationale,unlocks_capability_id,risk_note,for_asset_id,for_mission_id) VALUES ('crawler-led-kit','Cheapest path ΓÇö multiple small LEDs you can place and offset individually off the lens axis.','night-ops',NULL,'beast','undercroft');
INSERT INTO wishlist_meta(asset_id,rationale,unlocks_capability_id,risk_note,for_asset_id,for_mission_id) VALUES ('depth-cam','Factory-calibrated RGB-D on one USB stream ΓÇö erases camera intrinsics, extrinsics, and time-sync work. Computes depth onboard, so the host streams it without a GPU. The "reach high but solve power" first step.','rgbd-perception','Compromises max range vs standalone LiDAR.','beast','perimeter-mapping');
INSERT INTO wishlist_meta(asset_id,rationale,unlocks_capability_id,risk_note,for_asset_id,for_mission_id) VALUES ('standalone-lidar','Mind-blowing range/coverage but LiDAR-only. Adds extrinsic calibration + time-sync burden, and more total draw ΓÇö compounds the Pi power problem. Defer until the pipeline exists.','long-range-mapping','Calibration + time-sync + power burden; drifts with vibration on a tracked base.','beast',NULL);
INSERT INTO wishlist_meta(asset_id,rationale,unlocks_capability_id,risk_note,for_asset_id,for_mission_id) VALUES ('audeze-mm100','Top of the Audio Lab planar wishlist.',NULL,NULL,'rog-kithara',NULL);

-- insights + junctions
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('dust-backscatter','Offset lights from the camera lens','In a dusty crawlspace, a light next to the lens illuminates floating dust between camera and target ΓÇö driving in glowing fog. Mount low/forward, angled down, or off to the side; favour wide flood over spot to avoid hot centres and glare off galvanized duct.','high',NULL,'2026-05-31');
...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('power-rail','Power lights off the battery rail, not the Pi','RC crawler lights are rated 2SΓÇô3S, so they run straight off the ~11.1V pack through the driver board ΓÇö drawing nothing from the constrained 5V/5A Pi rail. The elegant option is also the power-friendly one.','high',NULL,'2026-05-31');
...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('watchdog','Stale-command watchdog beats latency worries','The risk on WiFi is the tail, not the median. A cheap onboard reflex ΓÇö "no fresh command in N ms ΓåÆ stop or coast" ΓÇö turns a dropped packet into a brief pause instead of a crash. Lives on the Pi/ESP32, never depends on the link.','high',NULL,'2026-05-31');
...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('depth-onboard','Integrated depth cameras compute depth onboard','An integrated RGB-D camera ships factory-calibrated and computes depth on-device, so the Pi can stream fused RGB-D without a GPU ΓÇö erasing intrinsics, extrinsics, and time-sync from the to-do list.','high',NULL,'2026-05-31');
...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('calibration-burden','Separate camera + LiDAR = real calibration burden','You produce a 6-DOF rigid transform plus time sync. Sleeper problems: time sync (independent clocks smear points in motion) and drift (vibration + thermal cycling walk the extrinsic off true ΓÇö worse on a tracked base). Standalone LiDAR also adds power draw.','high','koide3/direct_visual_lidar_calibration','2026-05-31');
...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('orin-tier','Orin Nano is the stable mainstream entry tier','NVIDIA gave Orin the free "Super" boost and extended its lifecycle through 2032. Buying an Orin Nano Super now is not buying into something about to be discontinued ΓÇö it is the mainstream tier for years.','high',NULL,'2026-05-31');
...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('blackwell-gap','No Blackwell Nano exists ΓÇö yet','Blackwell in Jetson is top-end only (Thor T4000/T5000). The Nano/NX tiers are still Ampere. The genuinely Blackwell option you already own is the 5090 ΓÇö which is exactly why offload-over-WiFi is worth taking seriously.','high',NULL,'2026-05-31');
...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('thor-tier','Thor is industrial-tier, wrong size for a rover','Thor (T4000/T5000) targets humanoids and warehouse AMRs that must run large VLA models fully onboard with the power budget to carry a 40ΓÇô130 W brain. A tracked hobby rover within AP range is not that animal.','high',NULL,'2026-05-31');
...
-- activity_log
INSERT INTO activity_log(id,at,kind,text) VALUES ('a1','2026-05-31T16:15:00Z','mission','Mission: Undercroft opened ΓÇö status Planning.');
