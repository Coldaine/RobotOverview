...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('beast-llm-jobs','On BEAST, the LLM is a crawlspace co-pilot','Worth building, in order: (1) phrase driving — “creep under the duct / nudge left / stop” → clamped L/R bursts; (2) look-where-I-mean gimbal aims from FPV + phrase; (3) scene coach HUD that narrates clearances while you still drive; (4) confirmed multi-step cable-haul chunks for Undercroft. Later: taught crawl segments via LeRobot. Not jobs: unattended patrol, stock DROID arm policies on tracks, or replacing the watchdog/PID.','high','docs/plans/2026-07-22-robot-control-llms-briefing.md#what-we-would-actually-have-it-do-on-beast-01','2026-07-22');
