...
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('workstation','module','Threadripper / RTX 5090',NULL,NULL,'CORE-PRIME','operational',NULL,'owner',true,'Blackwell-class desktop. The off-board "cloud brain" for the fleet: trains policies, runs VLM/LLM reasoning, heavy perception — streamed to units over WiFi 6. Compute is never the bottleneck; the network tail is.',NULL,NULL,NULL,'owned',NULL,1,600,NULL,'mains',NULL,NULL,NULL,'[{"label":"GPU","value":"RTX 5090 · 32GB GDDR7"},{"label":"Arch","value":"Blackwell"},{"label":"CPU","value":"Threadripper"},{"label":"Role","value":"Train + offboard inference"},{"label":"Link","value":"WiFi 6 LAN to fleet"}]'::jsonb,NULL,NULL,NULL);
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('pi5','module','Raspberry Pi 5',NULL,NULL,'EDGE-PI','operational',NULL,'owner',false,'Onboard host on the Beast: teleop, streaming, I/O, and the stale-command watchdog. No CUDA GPU, so learned-policy inference lives offboard on the 5090. Constrained 5V/5A rail is a real design limit.',NULL,NULL,NULL,'owned',NULL,1,25,5,'5V',NULL,NULL,NULL,'[{"label":"SoC","value":"BCM2712 · quad A76"},{"label":"GPU","value":"VideoCore (no CUDA)"},{"label":"Rail","value":"5V / 5A — protect it"},{"label":"Role","value":"Teleop · stream · watchdog"}]'::jsonb,NULL,NULL,NULL);
...
INSERT INTO assets(id,kind,name,manufacturer,model,callsign,status,lifecycle,provenance,flagship,summary,description,planning_notes,monitored_via,acquired,horizon,quantity,power_watts,power_volts,power_rail,mass_grams,price_us,price_import,specs,links,limitations,sources) VALUES ('home-assistant','module','Home Assistant Hub',NULL,NULL,'HA-CORE','operational',NULL,'owner',false,'Whole-home automation brain with a Thread border router. Referenced by the Hangar, never controlled by it — the Hangar catalogs, it does not operate.',NULL,NULL,NULL,'owned',NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,'[{"label":"Thread","value":"ZBT-2 border router"},{"label":"Climate","value":"Ecobee"},{"label":"Pool","value":"Pentair via Elfin EW11"},{"label":"Irrigation","value":"B-hyve"},{"label":"Energy","value":"Emporia Vue"},{"label":"Display","value":"LG C5 OLED"}]'::jsonb,NULL,NULL,NULL);
