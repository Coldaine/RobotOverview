...
-- activity_log
INSERT INTO activity_log(id,at,kind,text) VALUES ('a-jetson-flash-bct','2026-07-11T18:40:00Z','insight','OP-JETSON-FLASH reproduced the first signed recovery-BCT failure natively on EVO, exonerating its VM/VFIO path; the Intel control is staged and no QSPI or NVMe write occurred.');
