...
INSERT INTO insights(id,title,body,confidence,source,captured_at) VALUES ('beast-llm-jobs','On BEAST, the LLM path ends in self-driving missions','Build order: (1) phrase driving — “creep under the duct / nudge left / stop” → clamped L/R; (2) look-where-I-mean gimbal from FPV + phrase; (3) scene coach HUD; (4) autonomous Undercroft cable-haul along taught/mapped paths with live abort; (5) closed-loop crawl/patrol policies via LeRobot, later Cosmos Edge post-train. Not jobs: stock DROID arm policies on tracks, or replacing the watchdog/PID. Pool deck stays geofenced low-speed.','high','docs/plans/2026-07-22-robot-control-llms-briefing.md#what-we-would-actually-have-it-do-on-beast-01','2026-07-22');
