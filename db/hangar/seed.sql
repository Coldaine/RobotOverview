...
INSERT INTO asset_shortcuts(asset_id,position,label,type,url,command,note) VALUES ('beast',0,'Control UI','url','http://192.168.20.184:5000',NULL,'Pre-cutover Pi endpoint — offline until Orin assumes beast identity');
INSERT INTO asset_shortcuts(asset_id,position,label,type,url,command,note) VALUES ('beast',1,'JupyterLab','url','http://192.168.20.184:8888',NULL,'Pre-cutover Pi endpoint — offline until Orin assumes beast identity');
INSERT INTO asset_shortcuts(asset_id,position,label,type,url,command,note) VALUES ('beast',2,'Camera stream','url','http://192.168.20.184:5000/video_feed',NULL,'Pre-cutover Pi endpoint — offline until Orin assumes beast identity');
INSERT INTO asset_shortcuts(asset_id,position,label,type,url,command,note) VALUES ('beast',3,'SSH','command',NULL,'ssh ws@192.168.20.184','Pre-cutover Pi identity — re-point after Orin DHCP/DNS cutover');
